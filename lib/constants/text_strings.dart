//application
const String appName = "Flutter Starter";
...
const String onBoardingSubtitle1 =
    "Let's start your journey with us on this amazing and easy way to";
const String onBoardingSubtitle2 =
    "Get Video Tutorials from Youtube and learn from there.";
const String onBoardingSubtitle3 =
    "Get the code of the tutorials and resources to build your own.";
...
const String welcomeSubTitle =
    "Let's put your creativity on the development highway, craft ";
...
const String forgetMailSubTitle =
    "Enter your registered Mail No to receive OTP";
